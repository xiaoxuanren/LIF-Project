...
## Project Grounding
- Treat `LIF_network_simulation_network_burst_conductance.ipynb` as the current simulation source of truth unless the user explicitly chooses a legacy notebook.
