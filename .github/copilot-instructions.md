...
- Treat `LIF_network_simulation_network_burst_conductance.ipynb` as the current source of truth for simulation work unless the user explicitly asks to use a legacy notebook.
