...
- Treat `LIF_network_simulation_nc_sim_noise_stim.ipynb` (plus the `lif_simulation/` package) as the current source of truth for simulation work unless the user explicitly asks to use a legacy notebook.
