...
def build_parser():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.0,
        help="Standard deviation of additive membrane noise for stimulus-driven runs; spontaneous mode forces actual noise to 0.",
    )
    parser.add_argument("--spontaneous-baseline-mean", type=float, default=0.11)
    parser.add_argument("--spontaneous-baseline-sd", type=float, default=0.05)
    parser.add_argument("--spontaneous-baseline-seed", type=int, default=None)
    parser.add_argument("--spontaneous-exc-weight-scale", type=float, default=0.65)
    parser.add_argument("--spontaneous-burst-frac-thresh", type=float, default=0.12)
...
def main():
    ...
    spontaneous_baseline_seed = args.spontaneous_baseline_seed
    if spontaneous_baseline_seed is None:
        spontaneous_baseline_seed = args.seed if args.seed is not None else 0
    ...
    session_metadata = sequential_simulation_individual_saves(
        ...
        spontaneous_baseline_mean=args.spontaneous_baseline_mean,
        spontaneous_baseline_sd=args.spontaneous_baseline_sd,
        spontaneous_baseline_seed=spontaneous_baseline_seed,
        spontaneous_exc_weight_scale=args.spontaneous_exc_weight_scale,
        spontaneous_burst_frac_thresh=args.spontaneous_burst_frac_thresh,
